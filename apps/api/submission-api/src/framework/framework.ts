...
// https://davidtimms.github.io/submissionming-languages/typescript/2020/11/20/exploring-template-literal-types-in-typescript-4.1.html
...
//     body: z.object({
//       submissions: z.array(Annualsubmission),
//     }),
//     params: z.object({
//       annualsubmissionId: z.string(),
//     }),
//     query: z.object({
//       aa: z.string(),
//       bb: z.number(),
...
// type B1 = GetBodyKey<CreateAnnualsubmissionRequest>;
// type B2 = GetBodyKey<TestRequest>;

// type B3 = GetParamKey<CreateAnnualsubmissionRequest>;
// type B4 = GetParamKey<TestRequest>;

// type B5 = GetQueryKey<CreateAnnualsubmissionRequest>;
...
// type P = CleanEmpty<ParametersFromRequest<GetAnnualsubmissionRequest>>;
...
// type PartialService2 = DeclareServiceHandler<CreateAnnualsubmissionRequest, Annualsubmission[], 'annual-submission.create'>;

// type makeServiceWithHandlers =
//   DeclareServiceHandler<TestRequest, number[], 'test-handler-1'> &
//   DeclareServiceHandler<TestRequest1, Annualsubmission[], 'test-handler-2'>;

// type MyTestService = makeServiceWithHandlers

// const createMyTestService = (): MyTestService => {
//   return {
//     'test-handler-1': ({annualsubmissionId}) => {
//       console.log(annualsubmissionId)
