...
@Directive({
  ...
  selector: 'vdm-avatar-content, [vdm-avatar-content]',
  standalone: true,
  exportAs: 'vdmAvatarContent',
})
export class AvatarContentDirective {
  @HostBinding('class') hostClass = 'vdm-avatar-content';
}
...
export class AvatarComponent implements AfterViewInit {
  ...
  @HostBinding('class') hostClass = 'vdm-avatar';
  @HostBinding('class.vdm-avatar-color-1') get isColor1() {
    return this.color === 'background-color-1';
  }
  @HostBinding('class.vdm-avatar-color-2') get isColor2() {
    return this.color === 'background-color-2';
  }
  @HostBinding('class.vdm-avatar-color-3') get isColor3() {
    return this.color === 'background-color-3';
  }
  @HostBinding('class.vdm-avatar-color-4') get isColor4() {
    return this.color === 'background-color-4';
  }
  @HostBinding('class.vdm-avatar-color-5') get isColor5() {
    return this.color === 'background-color-5';
  }
  @HostBinding('class.vdm-avatar-color-6') get isColor6() {
    return this.color === 'background-color-6';
  }
  @HostBinding('class.vdm-avatar-color-7') get isColor7() {
    return this.color === 'background-color-7';
  }
  @HostBinding('class.vdm-avatar-color-8') get isColor8() {
    return this.color === 'background-color-8';
  }
  @HostBinding('class.vdm-avatar-color-9') get isColor9() {
    return this.color === 'background-color-9';
  }
  @HostBinding('class.vdm-avatar-color-10') get isColor10() {
    return this.color === 'background-color-10';
  }
  ...
  ngAfterViewInit(): void {
    ...
    if (this.nativeElement.firstChild && this.nativeElement.firstChild.nodeName === 'SPAN') {
  ...
  private setProfileName(name: string, content: Node | null): void {
    if (!content) return;
  ...
  private formatInitials(content: Node): void {
    ...
    if (firstChild) {
      ...
      if (nodeValue) this.renderer.setValue(firstChild, nodeValue.slice(0, 2));
    }
